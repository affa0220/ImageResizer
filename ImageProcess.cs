...
namespace ImageResizer
{
    public class ImageProcess
    {
        ...
        {
            string[] fileExtentionNames = { "*.png", "*.jpg", "*.jpeg" };
            var files = new List<string>();

            foreach (var names in fileExtentionNames)
            {
                files.AddRange(Directory.GetFiles(srcPath, names, SearchOption.AllDirectories));
            }
        ...
        /// <param name="srcPath">圖片來源目錄路徑</param>
        /// <returns></returns>
        public List<string> FindImagesByName(string srcPath, string name)
        {
            var files = new List<string>();
            files.AddRange(Directory.GetFiles(srcPath, name, SearchOption.AllDirectories));
        ...
        {
            string[] fileNames = { "*.png", "*.jpg", "*.jpeg" };

            var jobs = new List<Task>();
            foreach (var name in fileNames)
            {
                var files = FindImagesByName(sourcePath, name);
